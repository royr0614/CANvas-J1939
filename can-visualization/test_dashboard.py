#!/usr/bin/env python3
"""
Test script for the CAN visualization dashboard
...
class TestDashboardApp(QMainWindow):
    """Test application for the dashboard view"""
    ...
    def __init__(self):
        ...
        self.setWindowTitle("CAN Dashboard Test")
